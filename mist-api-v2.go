...
// MistApiV2DescribeAuth Authentication info
func MistApiV2DescribeAuth(params *viper.Viper) (*gentleman.Response, map[string]interface{}, cli.CLIOutputOptions, error) {
	handlerPath := "describe-auth"
...
// MistApiV2ListSessions List sessions
func MistApiV2ListSessions(params *viper.Viper) (*gentleman.Response, map[string]interface{}, cli.CLIOutputOptions, error) {
	handlerPath := "list-sessions"
	if mistApiV2Subcommand {
		handlerPath = "Mist CLI " + handlerPath
	}
	...
	url := server + "/api/v2/auth/sessions"
	...
	return resp, decoded, cli.CLIOutputOptions{[]string{"last_active"}, []string{"last_active", "id", "creation_date"}, []string{}, []string{}, map[string]string{}}, nil
}

// MistApiV2Login Sign in to the portal
func MistApiV2Login(params *viper.Viper, body string) (*gentleman.Response, map[string]interface{}, cli.CLIOutputOptions, error) {
	handlerPath := "login"
	if mistApiV2Subcommand {
		handlerPath = "Mist CLI " + handlerPath
	}
...
// MistApiV2ListTokens List API tokens
func MistApiV2ListTokens(params *viper.Viper) (*gentleman.Response, map[string]interface{}, cli.CLIOutputOptions, error) {
	handlerPath := "list-tokens"
	if mistApiV2Subcommand {
		handlerPath = "Mist CLI " + handlerPath
	}
...
// MistApiV2CreateToken Create token
func MistApiV2CreateToken(params *viper.Viper) (*gentleman.Response, map[string]interface{}, cli.CLIOutputOptions, error) {
	handlerPath := "create-token"
	if mistApiV2Subcommand {
		handlerPath = "Mist CLI " + handlerPath
	}
...
func MistApiV2GetCluster(paramCluster string, params *viper.Viper) (*gentleman.Response, map[string]interface{}, cli.CLIOutputOptions, error) {
	...
	return resp, decoded, cli.CLIOutputOptions{[]string{"name", "cloud", "total_nodes", "tags"}, []string{"id", "name", "cloud", "total_nodes", "total_cpus", "total_ram", "tags", "owned_by", "created_by"}, []string{}, []string{}, map[string]string{"credentials": "bool"}}, nil
}

// MistApiV2ScaleNodepool Scale cluster nodepool
func MistApiV2ScaleNodepool(paramCluster string, paramNodepool string, params *viper.Viper, body string) (*gentleman.Response, interface{}, cli.CLIOutputOptions, error) {
	handlerPath := "scale-nodepool"
	if mistApiV2Subcommand {
		handlerPath = "Mist CLI " + handlerPath
	}
	...
	url := server + "/api/v2/clusters/{cluster}/nodepools/{nodepool}"
	url = strings.Replace(url, "{cluster}", paramCluster, 1)
	url = strings.Replace(url, "{nodepool}", paramNodepool, 1)
...
func MistApiV2GetKey(paramKey string, params *viper.Viper) (*gentleman.Response, map[string]interface{}, cli.CLIOutputOptions, error) {
	...
	return resp, decoded, cli.CLIOutputOptions{[]string{"name", "default", "tags"}, []string{"id", "name", "default", "tags", "owned_by", "created_by"}, []string{}, []string{}, map[string]string{"private": "bool"}}, nil
}
...
func MistApiV2ListSchedules(params *viper.Viper) (*gentleman.Response, map[string]interface{}, cli.CLIOutputOptions, error) {
	handlerPath := "list-schedules"
	if mistApiV2Subcommand {
		handlerPath = "Mist CLI " + handlerPath
	}
...
func MistApiV2AddSchedule(params *viper.Viper, body string) (*gentleman.Response, map[string]interface{}, cli.CLIOutputOptions, error) {
	handlerPath := "add-schedule"
	if mistApiV2Subcommand {
		handlerPath = "Mist CLI " + handlerPath
	}
...
func MistApiV2DeleteSchedule(paramSchedule string, params *viper.Viper) (*gentleman.Response, interface{}, cli.CLIOutputOptions, error) {
	handlerPath := "delete-schedule"
	if mistApiV2Subcommand {
		handlerPath = "Mist CLI " + handlerPath
	}
	...
	url := server + "/api/v2/schedules/{schedule}"
	url = strings.Replace(url, "{schedule}", paramSchedule, 1)
...
func MistApiV2GetSchedule(paramSchedule string, params *viper.Viper) (*gentleman.Response, map[string]interface{}, cli.CLIOutputOptions, error) {
	handlerPath := "get-schedule"
	if mistApiV2Subcommand {
		handlerPath = "Mist CLI " + handlerPath
	}
...
func MistApiV2EditSchedule(paramSchedule string, params *viper.Viper, body string) (*gentleman.Response, interface{}, cli.CLIOutputOptions, error) {
	handlerPath := "edit-schedule"
	if mistApiV2Subcommand {
		handlerPath = "Mist CLI " + handlerPath
	}
...
func MistApiV2GetSecret(paramSecret string, params *viper.Viper) (*gentleman.Response, map[string]interface{}, cli.CLIOutputOptions, error) {
	...
	return resp, decoded, cli.CLIOutputOptions{[]string{"id", "name", "tags"}, []string{"id", "name", "tags", "owned_by", "created_by"}, []string{}, []string{}, map[string]string{"value": "bool"}}, nil
}
...
func MistApiV2ListRecords(paramZone string, params *viper.Viper) (*gentleman.Response, map[string]interface{}, cli.CLIOutputOptions, error) {
	...
	url := server + "/api/v2/zones/{zone}/records"
	url = strings.Replace(url, "{zone}", paramZone, 1)
	...
	return resp, decoded, cli.CLIOutputOptions{[]string{"name", "cloud"}, []string{"id", "name", "cloud", "external_id"}, []string{}, []string{}, map[string]string{}}, nil
}

// MistApiV2CreateRecord Create record
func MistApiV2CreateRecord(paramZone string, params *viper.Viper, body string) (*gentleman.Response, map[string]interface{}, cli.CLIOutputOptions, error) {
	handlerPath := "create-record"
	if mistApiV2Subcommand {
		handlerPath = "Mist CLI " + handlerPath
	}
...
func MistApiV2DeleteRecord(paramZone string, paramRecord string, params *viper.Viper) (*gentleman.Response, interface{}, cli.CLIOutputOptions, error) {
	...
	url := server + "/api/v2/zones/{zone}/records/{record}"
	url = strings.Replace(url, "{zone}", paramZone, 1)
	url = strings.Replace(url, "{record}", paramRecord, 1)
...
func MistApiV2GetRecord(paramZone string, paramRecord string, params *viper.Viper) (*gentleman.Response, map[string]interface{}, cli.CLIOutputOptions, error) {
	...
	return resp, decoded, cli.CLIOutputOptions{[]string{"name", "cloud"}, []string{"id", "name", "cloud", "external_id", "owned_by", "created_by"}, []string{}, []string{}, map[string]string{}}, nil
}
...
func mistApiV2Register(subcommand bool) {
	...
	func() {
		...
		cmd := &cobra.Command{
			Use:     "describe-auth",
			Short:   "Authentication info",
			Long:    cli.Markdown("Return info about current authenticated session."),
			Hidden:  true,
			Example: examples,
			Args:    cobra.MinimumNArgs(0),
			Run: func(cmd *cobra.Command, args []string) {

				_, decoded, outputOptions, err := MistApiV2DescribeAuth(params)
				if err != nil {
	...
	func() {
		...
		cmd := &cobra.Command{
			...
			Run: func(cmd *cobra.Command, args []string) {
				...
				_, decoded, outputOptions, err := MistApiV2ListSessions(params)
				if err != nil {
					logger.Fatalf("Error calling operation: %s", err.Error())
				}
	...
	func() {
		...
		cmd := &cobra.Command{
			Use:     "login",
			Short:   "Sign in to the portal",
			Long:    cli.Markdown("Sign in"),
			Hidden:  true,
			Example: examples,
			Args:    cobra.MinimumNArgs(0),
			Run: func(cmd *cobra.Command, args []string) {
				...
				_, decoded, outputOptions, err := MistApiV2Login(params, body)
				if err != nil {
					logger.Fatalf("Error calling operation: %s", err.Error())
				}
	...
	func() {
		...
		cmd := &cobra.Command{
			...
			Long:    cli.Markdown("List API tokens"),
			Hidden:  true,
			Example: examples,
			Args:    cobra.MinimumNArgs(0),
			Run: func(cmd *cobra.Command, args []string) {

				_, decoded, outputOptions, err := MistApiV2ListTokens(params)
				if err != nil {
					logger.Fatalf("Error calling operation: %s", err.Error())
				}
	...
	func() {
		...
		cmd := &cobra.Command{
			Use:     "create-token",
			Short:   "Create token",
			Long:    cli.Markdown("Create new API token"),
			Hidden:  true,
			Example: examples,
			Args:    cobra.MinimumNArgs(0),
			Run: func(cmd *cobra.Command, args []string) {

				_, decoded, outputOptions, err := MistApiV2CreateToken(params)
				if err != nil {
					logger.Fatalf("Error calling operation: %s", err.Error())
				}
	...
	func() {
		...
		cmd := &cobra.Command{
			Use:     "scale-nodepool CLUSTER NODEPOOL",
			Short:   "Scale cluster nodepool",
			Long:    cli.Markdown("Scale the nodes of the specified nodepool"),
			Hidden:  true,
			Example: examples,
			Args:    cobra.MinimumNArgs(2),
			Run: func(cmd *cobra.Command, args []string) {
				body, err := cli.GetBody("application/json", args[2:], params.GetString("filename"))
				if err != nil {
					logger.Fatalf("Unable to get body: %s", err.Error())
				}

				_, decoded, outputOptions, err := MistApiV2ScaleNodepool(args[0], args[1], params, body)
				if err != nil {
					logger.Fatalf("Error calling operation: %s", err.Error())
				}
	...
	func() {
		...
		examples += "  " + cli.Root.CommandPath() + " add-rule actions[].action_type: stop, conditions[]{data_type: logs, query{aggregation: count, operator: ge, target: type:request and action:reboot_machine, threshold: 10}, window{period: hours, start: 2, stop: 1}}, description: @file, name: NewStopMachineIntervalRule, selectors[]{ids: 738f633d987148a8b2c1628e0cd416b4, type: machines}, trigger_after{offset: 8, period: hours}, when{every: 2, period: hours, schedule_type: interval}\n"
	...
	func() {
		...
		cmd := &cobra.Command{
			...
			Long:    cli.Markdown("List schedules owned by the active org. READ permission required on schedules."),
			Hidden:  true,
			Example: examples,
			Args:    cobra.MinimumNArgs(0),
			Run: func(cmd *cobra.Command, args []string) {

				_, decoded, outputOptions, err := MistApiV2ListSchedules(params)
				if err != nil {
					logger.Fatalf("Error calling operation: %s", err.Error())
				}
	...
	func() {
		...
		cmd := &cobra.Command{
			Use:     "add-schedule",
			Short:   "Add schedule",
			Long:    cli.Markdown("Add schedule to user schedules"),
			Hidden:  true,
			Example: examples,
			Args:    cobra.MinimumNArgs(0),
			Run: func(cmd *cobra.Command, args []string) {
				...
				_, decoded, outputOptions, err := MistApiV2AddSchedule(params, body)
				if err != nil {
					logger.Fatalf("Error calling operation: %s", err.Error())
				}
	...
	func() {
		...
		cmd := &cobra.Command{
			Use:     "delete-schedule SCHEDULE",
			Short:   "Delete schedule",
			Long:    cli.Markdown("Delete target schedule"),
			Hidden:  true,
			Example: examples,
			Args:    cobra.MinimumNArgs(1),
			Run: func(cmd *cobra.Command, args []string) {

				_, decoded, outputOptions, err := MistApiV2DeleteSchedule(args[0], params)
				if err != nil {
					logger.Fatalf("Error calling operation: %s", err.Error())
				}
	...
	func() {
		...
		cmd := &cobra.Command{
			...
			Short:   "Get schedule",
			Long:    cli.Markdown("Get details about target schedule"),
			Hidden:  true,
			Example: examples,
			Args:    cobra.MinimumNArgs(1),
			Run: func(cmd *cobra.Command, args []string) {

				_, decoded, outputOptions, err := MistApiV2GetSchedule(args[0], params)
				if err != nil {
					logger.Fatalf("Error calling operation: %s", err.Error())
				}
	...
	func() {
		...
		cmd := &cobra.Command{
			...
			Short:   "Edit schedule",
			Long:    cli.Markdown("Edit target schedule"),
			Hidden:  true,
			Example: examples,
			Args:    cobra.MinimumNArgs(1),
			Run: func(cmd *cobra.Command, args []string) {
				...
				_, decoded, outputOptions, err := MistApiV2EditSchedule(args[0], params, body)
				if err != nil {
					logger.Fatalf("Error calling operation: %s", err.Error())
				}
	...
	func() {
		...
		examples += "  " + cli.Root.CommandPath() + " create-record ZONE name: my-record, value: 123.23.23.2\n"

		cmd := &cobra.Command{
			Use:     "create-record ZONE",
			Short:   "Create record",
			Long:    cli.Markdown("Creates a new record under a specific zone. CREATE_RESOURCES permission required on cloud. CREATE_RECORDS permission required on zone"),
			Hidden:  true,
			Example: examples,
			Args:    cobra.MinimumNArgs(1),
			Run: func(cmd *cobra.Command, args []string) {
				...
				_, decoded, outputOptions, err := MistApiV2CreateRecord(args[0], params, body)
				if err != nil {
					logger.Fatalf("Error calling operation: %s", err.Error())
				}
	...
	func() {
		...
		cmd.SetUsageTemplate("/api/v2#" + strings.ToLower("Get") + "-" + strings.ReplaceAll(strings.ReplaceAll("/api/v2/auth", "{", "-"), "}", "-"))
	...
	func() {
		...
		cmd.SetErr(os.Stderr)
		cmd.SetUsageTemplate("/api/v2#" + strings.ToLower("Get") + "-" + strings.ReplaceAll(strings.ReplaceAll("/api/v2/auth/sessions", "{", "-"), "}", "-"))
		cmd.SetUsageFunc(customUsageFunc)
	...
	func() {
		...
		cmd.SetErr(os.Stderr)
		cmd.SetUsageTemplate("/api/v2#" + strings.ToLower("Post") + "-" + strings.ReplaceAll(strings.ReplaceAll("/api/v2/auth/sessions", "{", "-"), "}", "-"))
		cmd.SetUsageFunc(customUsageFunc)
	...
	func() {
		...
		cmd.SetErr(os.Stderr)
		cmd.SetUsageTemplate("/api/v2#" + strings.ToLower("Get") + "-" + strings.ReplaceAll(strings.ReplaceAll("/api/v2/auth/tokens", "{", "-"), "}", "-"))
		cmd.SetUsageFunc(customUsageFunc)
		getCmd.AddCommand(cmd)
	...
	func() {
		...
		cmd.SetErr(os.Stderr)
		cmd.SetUsageTemplate("/api/v2#" + strings.ToLower("Post") + "-" + strings.ReplaceAll(strings.ReplaceAll("/api/v2/auth/tokens", "{", "-"), "}", "-"))
		cmd.SetUsageFunc(customUsageFunc)
	...
	func() {
		...
		cmd.SetErr(os.Stderr)
		cmd.SetUsageTemplate("/api/v2#" + strings.ToLower("Post") + "-" + strings.ReplaceAll(strings.ReplaceAll("/api/v2/clusters/{cluster}/nodepools/{nodepool}", "{", "-"), "}", "-"))
		cmd.SetUsageFunc(customUsageFunc)
	...
	func() {
		...
		cmd.SetErr(os.Stderr)
		cmd.SetUsageTemplate("/api/v2#" + strings.ToLower("Get") + "-" + strings.ReplaceAll(strings.ReplaceAll("/api/v2/schedules", "{", "-"), "}", "-"))
		cmd.SetUsageFunc(customUsageFunc)
		getCmd.AddCommand(cmd)
	...
	func() {
		...
		cmd.SetErr(os.Stderr)
		cmd.SetUsageTemplate("/api/v2#" + strings.ToLower("Post") + "-" + strings.ReplaceAll(strings.ReplaceAll("/api/v2/schedules", "{", "-"), "}", "-"))
		cmd.SetUsageFunc(customUsageFunc)
		addCmd.AddCommand(cmd)
		cmd.Flags().StringP("filename", "f", "", "Filename")
	...
	func() {
		...
		cmd.SetErr(os.Stderr)
		cmd.SetUsageTemplate("/api/v2#" + strings.ToLower("Delete") + "-" + strings.ReplaceAll(strings.ReplaceAll("/api/v2/schedules/{schedule}", "{", "-"), "}", "-"))
		cmd.SetUsageFunc(customUsageFunc)
		deleteCmd.AddCommand(cmd)
	...
	func() {
		...
		cmd.SetErr(os.Stderr)
		cmd.SetUsageTemplate("/api/v2#" + strings.ToLower("Patch") + "-" + strings.ReplaceAll(strings.ReplaceAll("/api/v2/schedules/{schedule}", "{", "-"), "}", "-"))
		cmd.SetUsageFunc(customUsageFunc)
		editCmd.AddCommand(cmd)
		cmd.Flags().StringP("filename", "f", "", "Filename")
	...
	func() {
		...
		cmd.SetErr(os.Stderr)
		cmd.SetUsageTemplate("/api/v2#" + strings.ToLower("Post") + "-" + strings.ReplaceAll(strings.ReplaceAll("/api/v2/zones/{zone}/records", "{", "-"), "}", "-"))
		cmd.SetUsageFunc(customUsageFunc)
		createCmd.AddCommand(cmd)
		cmd.Flags().StringP("filename", "f", "", "Filename")
