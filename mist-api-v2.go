...
func MistApiV2ListRecords(paramCloud string, paramZone string, params *viper.Viper) (*gentleman.Response, map[string]interface{}, cli.CLIOutputOptions, error) {
	...
	url := server + "/api/v2/records"

	req := cli.Client.Get().URL(url)

	req = req.AddQuery("cloud", paramCloud)

	req = req.AddQuery("zone", paramZone)
...
func MistApiV2CreateRecord(params *viper.Viper, body string) (*gentleman.Response, map[string]interface{}, cli.CLIOutputOptions, error) {
...
func MistApiV2DeleteRecord(paramRecord string, paramCloud string, paramZone string, params *viper.Viper) (*gentleman.Response, interface{}, cli.CLIOutputOptions, error) {
	...
	url := server + "/api/v2/records/{record}"
...
func MistApiV2GetRecord(paramRecord string, paramCloud string, paramZone string, params *viper.Viper) (*gentleman.Response, map[string]interface{}, cli.CLIOutputOptions, error) {
...
func mistApiV2Register(subcommand bool) {
	...
	func() {
		...
		examples += "  " + cli.Root.CommandPath() + " create-record cloud: my-cloud, name: my-record, zone: my-zone\n"
		...
		cmd := &cobra.Command{
			...
			Run: func(cmd *cobra.Command, args []string) {
				...
				_, decoded, outputOptions, err := MistApiV2CreateRecord(params, body)
				if err != nil {
					logger.Fatalf("Error calling operation: %s", err.Error())
				}
	...
	func() {
		...
		cmd := &cobra.Command{
			Use:     "delete-record RECORD CLOUD ZONE",
			Short:   "Delete record",
	...
	func() {
		...
		cmd := &cobra.Command{
			Use:     "get-record RECORD CLOUD ZONE",
			Short:   "Get record",
	...
	func() {
		...
		cmd.SetErr(os.Stderr)
		cmd.SetUsageTemplate("/api/v2#" + strings.ToLower("Get") + "-" + strings.ReplaceAll(strings.ReplaceAll("/api/v2/records", "{", "-"), "}", "-"))
		cmd.SetUsageFunc(customUsageFunc)
		getCmd.AddCommand(cmd)
	...
	func() {
		...
		cmd.SetErr(os.Stderr)
		cmd.SetUsageTemplate("/api/v2#" + strings.ToLower("Post") + "-" + strings.ReplaceAll(strings.ReplaceAll("/api/v2/records", "{", "-"), "}", "-"))
		cmd.SetUsageFunc(customUsageFunc)
		createCmd.AddCommand(cmd)
		cmd.Flags().StringP("filename", "f", "", "Filename")
	...
	func() {
		...
		cmd.SetErr(os.Stderr)
		cmd.SetUsageTemplate("/api/v2#" + strings.ToLower("Delete") + "-" + strings.ReplaceAll(strings.ReplaceAll("/api/v2/records/{record}", "{", "-"), "}", "-"))
		cmd.SetUsageFunc(customUsageFunc)
		deleteCmd.AddCommand(cmd)
