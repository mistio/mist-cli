...
// MistApiV2RunScript Download script
func MistApiV2RunScript(params *viper.Viper, body string) (*gentleman.Response, map[string]interface{}, cli.CLIOutputOptions, error) {
...
func MistApiV2DownloadScript(paramScript string, params *viper.Viper) (*gentleman.Response, interface{}, cli.CLIOutputOptions, error) {
	...
	url := server + "/api/v2/script/file/{script}"
	...
	func() {
		...
		cmd := &cobra.Command{
			...
			Run: func(cmd *cobra.Command, args []string) {
				...
				_, decoded, outputOptions, err := MistApiV2RunScript(params, body)
				if err != nil {
					logger.Fatalf("Error calling operation: %s", err.Error())
				}
